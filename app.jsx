...
function HomeContactLinks() {
  return (
    <nav className="home-contact-links" aria-label="Contact links">
      <a href="https://github.com/MFrancys" target="_blank" rel="noopener noreferrer" aria-label="GitHub" title="GitHub">
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path d="M12 2.6c-5.2 0-9.4 4.2-9.4 9.4 0 4.2 2.7 7.7 6.5 8.9.5.1.7-.2.7-.5v-1.8c-2.6.6-3.2-1.1-3.2-1.1-.4-1.1-1-1.4-1-1.4-.9-.6.1-.6.1-.6 1 0 1.5 1 1.5 1 .8 1.5 2.2 1 2.7.8.1-.6.3-1 .6-1.3-2.1-.2-4.3-1-4.3-4.6 0-1 .4-1.9 1-2.5-.1-.2-.4-1.2.1-2.5 0 0 .8-.3 2.6 1 .8-.2 1.6-.3 2.4-.3s1.7.1 2.4.3c1.8-1.2 2.6-1 2.6-1 .5 1.3.2 2.3.1 2.5.6.7 1 1.5 1 2.5 0 3.6-2.2 4.4-4.3 4.6.4.3.7.9.7 1.8v2.6c0 .3.2.6.7.5 3.8-1.3 6.5-4.8 6.5-8.9 0-5.2-4.2-9.4-9.4-9.4z" />
        </svg>
      </a>
      <a href="https://www.linkedin.com/in/francys-lanza-garc%C3%ADa-784865128/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" title="LinkedIn">
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path d="M5.2 8.8h3.1v10H5.2v-10zM6.7 4c1 0 1.8.8 1.8 1.7 0 1-.8 1.8-1.8 1.8S5 6.7 5 5.7C5 4.8 5.8 4 6.7 4zm3.5 4.8h3v1.4c.4-.8 1.5-1.6 3.1-1.6 3.3 0 3.9 2.2 3.9 5v5.2h-3.1v-4.6c0-1.1 0-2.5-1.5-2.5s-1.8 1.2-1.8 2.4v4.7h-3.1v-10z" />
        </svg>
      </a>
      <a href="mailto:mariafrancysucv@gmail.com" aria-label="Email Francys" title="Email">
        <svg viewBox="0 0 24 24" aria-hidden="true" className="home-contact-mail">
          <path d="M4.5 6.8h15v10.4h-15z" />
          <path d="M5.2 7.5 12 12.8l6.8-5.3" />
        </svg>
      </a>
    </nav>
  );
